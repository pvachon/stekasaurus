 ...
 */
#define STEK_ERROR_BIT                      (sresult_t)(0x80000000)
#define STEK_ERROR(_f, _c)                  (sresult_t)(((_f) & 0x7fff) << 16 | (_c) & 0xffff)
...
/**
 * Given a CBOR file containing the STEKs, load it into the stek_keys structure 
 */
